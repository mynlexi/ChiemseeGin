...
export default function dsvgo(){
  return (
    ...
    Datenschutzerklärung
      ...
      hohen Stellenwert für die Geschäftsleitung der Chiemsee Premium Gin UG (haftungsbeschränkt).
      Eine Nutzung der Internetseiten der Chiemsee Premium Gin UG (haftungsbeschränkt) ist
      ...
      Grundverordnung und in Übereinstimmung mit den für die Chiemsee Premium Gin UG

      (haftungsbeschränkt) geltenden landesspezifischen Datenschutzbestimmungen. Mittels dieser
      ...
      <p>
      Die Chiemsee Premium Gin UG (haftungsbeschränkt) hat als für die Verarbeitung Verantwortlicher
      ...
      <h2>2. Name und Anschrift des für die Verarbeitung Verantwortlichen</h2>
        ...
        <p>
        Chiemsee Premium Gin UG (haftungsbeschränkt)
        </p>
        <p>
        Haigermooser Str. 17
        </p>
      ...
      3. Cookies
        ...
        sind Textdateien, welche über einen Internetbrowser auf einem Computersystem abgelegt und
        ...
        <p>Durch den Einsatz von Cookies kann die Chiemsee Premium Gin UG (haftungsbeschränkt) den
        Nutzern dieser Internetseite nutzerfreundlichere Services bereitstellen, die ohne die Cookie-Setzung
      ...
      <h2>4. Erfassung von allgemeinen Daten und Informationen</h2>
        ...
        <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Chiemsee Premium Gin UG
        (haftungsbeschränkt) keine Rückschlüsse auf die betroffene Person. Diese Informationen werden
        ...
        Chiemsee Premium Gin UG (haftungsbeschränkt) daher einerseits statistisch und ferner mit dem Ziel
      ...
      <h2>5. Registrierung auf unserer Internetseite</h2>
        ...
        <p>Durch eine Registrierung auf der Internetseite des für die Verarbeitung Verantwortlichen wird ferner
        ...
        Weitergabe der Strafverfolgung dient.</p>
        <p>Der für die Verarbeitung Verantwortliche erteilt jeder betroffenen Person jederzeit auf Anfrage
      ...
      <h2>6. Abonnement unseres Newsletters</h2>
        ...
        Verantwortlichen übermittelt werden, ergibt sich aus der hierzu verwendeten Eingabemaske.</p>
        <p>Die Chiemsee Premium Gin UG (haftungsbeschränkt) informiert ihre Kunden und Geschäftspartner in
        regelmäßigen Abständen im Wege eines Newsletters über Angebote des Unternehmens. Der
        Newsletter unseres Unternehmens kann von der betroffenen Person grundsätzlich nur dann
        empfangen werden, wenn (1) die betroffene Person über eine gültige E-Mail-Adresse verfügt und (2)
        die betroffene Person sich für den Newsletterversand registriert. An die von einer betroffenen Person
        erstmalig für den Newsletterversand eingetragene E-Mail-Adresse wird aus rechtlichen Gründen eine
        Bestätigungsmail im Double-Opt-In-Verfahren versendet. Diese Bestätigungsmail dient der
        Überprüfung, ob der Inhaber der E-Mail-Adresse als betroffene Person den Empfang des Newsletters
        autorisiert hat.</p>
        <p>Bei der Anmeldung zum Newsletter speichern wir ferner die vom Internet-Service-Provider (ISP)
        ...
        <p>Die im Rahmen einer Anmeldung zum Newsletter erhobenen personenbezogenen Daten werden
      ...
      <h2>7. Newsletter-Tracking</h2>
        ...
        Dadurch kann eine statistische Auswertung des Erfolges oder Misserfolges von Online-Marketing-
        Kampagnen durchgeführt werden. Anhand des eingebetteten Zählpixels kann die Chiemsee Premium
        Gin UG (haftungsbeschränkt) erkennen, ob und wann eine E-Mail von einer betroffenen Person
        geöffnet wurde und welche in der E-Mail befindlichen Links von der betroffenen Person aufgerufen
        wurden.</p>
        <p>Solche über die in den Newslettern enthaltenen Zählpixel erhobenen personenbezogenen Daten,
      ...
      <h2>8. Kontaktmöglichkeit über die Internetseite</h2>
        ...
        allgemeine Adresse der sogenannten elektronischen Post (E-Mail-Adresse) umfasst. Sofern eine
        betroffene Person per E-Mail oder über ein Kontaktformular den Kontakt mit dem für die Verarbeitung
        Verantwortlichen aufnimmt, werden die von der betroffenen Person übermittelten personenbezogenen
        Daten automatisch gespeichert. Solche auf freiwilliger Basis von einer betroffenen Person an den für
      ...
      <h2>10. Rechte der betroffenen Person</h2>
        ...
        <h4>b) Recht auf Auskunft</h4>
          ...
          <ul>
            ...
            <li><p>die Empfänger oder Kategorien von Empfängern, gegenüber denen die personenbezogenen Daten offengelegt worden sind oder noch offengelegt werden, insbesondere bei Empfängern in Drittländern
              oder bei internationalen Organisationen</p></li>
            <li><p>falls möglich die geplante Dauer, für die die personenbezogenen Daten gespeichert werden, oder,
              falls dies nicht möglich ist, die Kriterien für die Festlegung dieser Dauer</p></li>
            <li><p>das Bestehen eines Rechts auf Berichtigung oder Löschung der sie betreffenden personenbezogenen
              Daten oder auf Einschränkung der Verarbeitung durch den Verantwortlichen oder eines
              Widerspruchsrechts gegen diese Verarbeitung</p></li>
            <li><p>das Bestehen eines Beschwerderechts bei einer Aufsichtsbehörde</p></li>
            <li><p>wenn die personenbezogenen Daten nicht bei der betroffenen Person erhoben werden: Alle
              verfügbaren Informationen über die Herkunft der Daten</p></li>
            <li><p>das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Artikel 22
      ...
      <ul>
        <li><p>Die personenbezogenen Daten wurden für solche Zwecke erhoben oder auf sonstige Weise
        verarbeitet, für welche sie nicht mehr notwendig sind.</p></li>
        <li><p>Die betroffene Person widerruft ihre Einwilligung, auf die sich die Verarbeitung gemäß Art. 6 Abs. 1
        Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO stützte, und es fehlt an einer
        anderweitigen Rechtsgrundlage für die Verarbeitung.</p></li>
        <li><p>Die betroffene Person legt gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein,
        und es liegen keine vorrangigen berechtigten Gründe für die Verarbeitung vor, oder die betroffene
        Person legt gemäß Art. 21 Abs. 2 DS-GVO Widerspruch gegen die Verarbeitung ein.</p></li>
        <li><p>Die personenbezogenen Daten wurden unrechtmäßig verarbeitet.</p></li>
        <li><p>Die Löschung der personenbezogenen Daten ist zur Erfüllung einer rechtlichen Verpflichtung nach
        dem Unionsrecht oder dem Recht der Mitgliedstaaten erforderlich, dem der Verantwortliche unterliegt.</p></li>
        <li><p>Die personenbezogenen Daten wurden in Bezug auf angebotene Dienste der Informationsgesellschaft
        gemäß Art. 8 Abs. 1 DS-GVO erhoben.</p></li>
      </ul>
      <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
      personenbezogenen Daten, die bei der Chiemsee Premium Gin UG (haftungsbeschränkt) gespeichert
      sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
      Verantwortlichen wenden. Der Mitarbeiter der Chiemsee Premium Gin UG (haftungsbeschränkt) wird
      veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.</p>
      <p>Wurden die personenbezogenen Daten von der Chiemsee Premium Gin UG (haftungsbeschränkt)
      öffentlich gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur
      Löschung der personenbezogenen Daten verpflichtet, so trifft die Chiemsee Premium Gin UG
      (haftungsbeschränkt) unter Berücksichtigung der verfügbaren Technologie und der
    ...
    <ul>
      <li><p>Die Richtigkeit der personenbezogenen Daten wird von der betroffenen Person bestritten, und zwar
      für eine Dauer, die es dem Verantwortlichen ermöglicht, die Richtigkeit der personenbezogenen Daten
      zu überprüfen.</p></li>
      <li><p>Die Verarbeitung ist unrechtmäßig, die betroffene Person lehnt die Löschung der personenbezogenen
      Daten ab und verlangt stattdessen die Einschränkung der Nutzung der personenbezogenen Daten.</p></li>
      <li><p>Der Verantwortliche benötigt die personenbezogenen Daten für die Zwecke der Verarbeitung nicht
      länger, die betroffene Person benötigt sie jedoch zur Geltendmachung, Ausübung oder Verteidigung
      von Rechtsansprüchen.</p></li>
      <li><p>Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs. 1 DS-GVO eingelegt
      und es steht noch nicht fest, ob die berechtigten Gründe des Verantwortlichen gegenüber denen der
      betroffenen Person überwiegen.</p></li>
    </ul>
    <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die
    Einschränkung von personenbezogenen Daten, die bei der Chiemsee Premium Gin UG
    ...
    <h4>f) Recht auf Datenübertragbarkeit</h4>
      ...
      <p>Ferner hat die betroffene Person bei der Ausübung ihres Rechts auf Datenübertragbarkeit gemäß Art.
    ...
    <h4>g) Recht auf Widerspruch</h4>
      ...
      <p>Die Chiemsee Premium Gin UG (haftungsbeschränkt) verarbeitet die personenbezogenen Daten im
      Falle des Widerspruchs nicht mehr, es sei denn, wir können zwingende schutzwürdige Gründe für die
      ...
      Rechtsansprüchen.</p>
      <p>Verarbeitet die Chiemsee Premium Gin UG (haftungsbeschränkt) personenbezogene Daten, um
      ...
      auch für das Profiling, soweit es mit solcher Direktwerbung in Verbindung steht. Widerspricht die
      betroffene Person gegenüber der Chiemsee Premium Gin UG (haftungsbeschränkt) der Verarbeitung
      für Zwecke der Direktwerbung, so wird die Chiemsee Premium Gin UG (haftungsbeschränkt) die
      ...
      ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der Chiemsee
      Premium Gin UG (haftungsbeschränkt) zu wissenschaftlichen oder historischen Forschungszwecken
      ...
      der Chiemsee Premium Gin UG (haftungsbeschränkt) oder einen anderen Mitarbeiter wenden. Der
    ...
    <h4>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h4>
      ...
      betroffenen Person, trifft die Chiemsee Premium Gin UG (haftungsbeschränkt) angemessene
